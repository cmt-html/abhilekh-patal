...
//   $(".searchinput").toggleAttr("style");
//   $("#asdvanceSearch").toggleAttr("style");
//   $("#containerAdvanceSearch").toggleAttr("style");
//   $("#asdvanceSearch").focus();
// }
...
$(document).mouseup(function (e) {
  var container = $(".asvanceSearch, .hoverdiv, .search-panel");
