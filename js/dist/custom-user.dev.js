...
$(document).mouseup(function (e) {
  var container = $(".asvanceSearch, .hoverdiv, .search-panel, .Bookmarks-div, .megahmenudrop"); // if the target of the click isn't the container nor a descendant of the container
